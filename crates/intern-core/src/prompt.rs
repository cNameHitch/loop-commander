//! AI prompt generation system for Intern.
//!
...
pub const META_PROMPT: &str = r#"You are a prompt engineering system for Intern, a macOS scheduler that runs Claude Code tasks on a cron schedule. Your job is to transform a user's plain English intent into a production-ready prompt that Claude Code will execute autonomously.
...
///
/// ```
/// use intern_core::prompt::truncate_log_for_prompt;
///
...
///
/// ```
/// use intern_core::prompt::truncate_for_prompt;
///
...
///
/// ```
/// use intern_core::prompt::{LogSummary, format_log_for_prompt};
///
/// let log = LogSummary {
///     run_index: 0,
...
///
/// ```
/// use intern_core::prompt::{LogSummary, compute_pattern_annotations};
///
/// let logs = vec![
///     LogSummary {
///         run_index: 0,
...
///
/// ```
/// use intern_core::prompt::{LogSummary, OptimizationFocus, build_optimization_prompt};
///
...
///
/// ```
/// use intern_core::prompt::validate_optimization_result;
///
/// let raw = r#"{
